        ...
        return (
          ...
          >
            ...
            {count !== undefined && count !== null && (
              <span className={`text-[12px] font-bold rounded-full px-1.5 py-0.5 ${
        ...
        <div className={`grid gap-4 sm:gap-6 items-start ${
          ...
          <BentoCard hover={false}>
            <div className="flex items-center gap-2 mb-0.5">
              <Target size={17} className="text-indigo-600 shrink-0" />
          ...
          <BentoCard hover={false}>
            ...
            <p className="text-xs text-gray-500 mb-4">Your next tasks, by the day they open</p>
      ...
      {view === 'focus' && !filtersOn && (
        <div className={`grid gap-4 sm:gap-6 items-start ${
          ...
          <BentoCard hover={false}>
            ...
            <p className="text-xs text-gray-500 mb-4">What has actually happened on your work</p>
      ...
      <section>
        ...
        {visible.length || lockedVisible.length ? (
          ...
          <BentoCard hover={false} className="text-center py-10">
            <ClipboardCheck size={30} className="text-gray-500 mx-auto mb-3" />
        ...
        <section>
          {selected ? (
            ...
            <BentoCard hover={false} className="text-center py-12">
              <MonitorPlay size={30} className="text-gray-500 mx-auto mb-3" />
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
          <BentoCard index={0}>
            ...
            <p className="text-xs text-gray-500 mb-2">Avg time from assigned to graded</p>
            <TaskVelocityBar data={velocity} />
          </BentoCard>

          <BentoCard index={1}>
            <h3 className="text-base font-bold mb-0.5">Task health</h3>
            <p className="text-xs text-gray-500 mb-4">Against each task's deadline</p>
          ...
          <BentoCard index={2}>
            ...
            <p className="text-xs text-gray-500 mb-3.5">Who assigned your tasks</p>
            {taskSources.length ? (
                ...
                {taskSources.map((s) => (
                  <div key={s.archetype} className="flex items-center gap-2.5">
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <div className="text-[12px] text-gray-500 uppercase font-bold tracking-wide">{s.graded} done</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <BentoCard index={3}>
            ...
            <p className="text-xs text-gray-500 mb-2.5">Quality, timeliness and consistency</p>

            <div className="flex items-baseline gap-1.5 mb-3">
              <span className="text-4xl font-extrabold text-gray-900 leading-none">
                {productivity.score === null ? '—' : productivity.score}
              </span>
              {productivity.score !== null && <span className="text-sm font-bold text-gray-500">/ 100</span>}
            </div>
            ...
            {productivity.score === null ? (
              ...
              <div className="space-y-2">
                  ...
                  <div key={p.key}>
                    <div className="flex items-baseline justify-between gap-2 mb-1">
                      <span className="text-[12px] font-semibold text-gray-600 truncate">
                        {p.label} <span className="text-gray-500 font-medium">{Math.round(p.weight * 100)}%</span>
                      </span>
                      <span className={`text-[12px] font-bold shrink-0 ${p.value === null ? 'text-gray-500' : 'text-gray-700'}`}>
                ...
                {trend.length > 1 && (
                  <div className="pt-1">
                    <div className="text-[12px] font-bold text-gray-500 uppercase tracking-wide mb-0.5">Trend</div>
